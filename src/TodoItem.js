                ...
                <div className="options">
                    <label>
                        ...
                        <svg className="completed" viewBox="0 0 1024 1024">
                            <path d="M158.208 457.216L339.456 601.6c16.256 12.928 39.552 12.16 54.784-1.92l495.104-456.192s35.072-32 65.536-7.04c9.088 7.552 19.584 28.8-4.096 62.08L406.144 765.696s-41.728 57.216-91.392-0.64L79.872 518.528s-27.904-42.88 7.04-68.736c11.648-8.576 38.4-22.016 71.296 7.424z"/>
                        </svg>
                    </label>
